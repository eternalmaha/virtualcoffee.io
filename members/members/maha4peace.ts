...
export const eternalmaha: MemberObject = {
	...
	// bio: `Software Engineer, specializing in front end development | Community | Equity | living fiercely in the present [https://maha-ahmed.netlify.app](https://virtualcoffee.io)`,
	//
	...
	accounts: [
		...
		// { type: 'website', url: 'https://maha-ahmed.netlify.app', title: 'Maha Ahmed's Portfolio' },
	],
	badges: [],
